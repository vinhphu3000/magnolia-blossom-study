 ...
 *
 */
package net.phuha.hrsystem.config;
...
/**
 * Configuration class for using Freemarker views. Import this class instead of {@link SiteAwareFreemarkerRenderingConfiguration} if you're not interested in merging in configuration from the site
...
public class FreemarkerRenderingConfiguration {
    ...
    public TemplateViewResolver freemarkerTemplateViewResolver(FreemarkerTemplateViewRenderer viewRenderer) {
        ...
        resolver.setOrder(3);
        resolver.setPrefix("/springintegration/");
